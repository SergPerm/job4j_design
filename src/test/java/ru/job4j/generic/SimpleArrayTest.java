...
public class SimpleArrayTest {
    ...
    public void iterator() {
        SimpleArray<Integer> simple = new SimpleArray<>(new Integer[]{1, 2, 3, 4});
    ...
    public void whenAdd10ThenGet10() {
        SimpleArray<Integer> simple = new SimpleArray<>(new Integer[10]);
        simple.add(10);
    ...
    @Test
    public void get() {
        SimpleArray<String> simple = new SimpleArray<>(new String[]{"1", "two", "3"});
